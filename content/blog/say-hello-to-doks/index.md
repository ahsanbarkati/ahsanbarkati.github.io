...
![Image](template-repo.jpg "Template repo")
...
![Image](create-repo.jpg "Template repo")
...
4. Push the changes, goto Actions tab in your github repo and you'll see the build would have started. After the build is complete, you can visit `http://username.github.io` to see your blogging website live. It would look something like this:
